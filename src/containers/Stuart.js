...
export default function Stuart(props) {
	const [isLoading, setIsLoading] = useState(false);
	const bobImageUrl = "https://minionshop-img-db.s3.us-east-2.amazonaws.com/stuartSqr500px.jpg";
	const productId = "MINION-STUART";
    ...
    return API.put("shopUsers", "/shopUsers/1/add", {
      body: {productId:productId,quantity:parseInt(quantity,10)}
    });
	...
	return (
		...
		<div class="row">
			<div class="col-sm-6 col-md-6 col-align-center">
				...
				<div class="thumbnail">
					<img class="img-responsive" src={bobImageUrl} alt="stuart"></img>
				</div>
			</div>
